...
void ex_analyse_ad_test::perform() throw(libtest::test_exception){
...
void ex_analyse_ad_test::test_ex_total(){

    static const char *testname = "ex_analyse_ad_test::test_ex_total()";
	...
	ab_matrix det(true);
	det.alpha() = tdm.alpha() * s * tdm.alpha().t();
